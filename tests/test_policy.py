...
from drive_audit.model import AccessInfo, DriveConfig, FileInfo, Permission, PolicyInfo
...
class TestPolicy(unittest.TestCase):
    ...
    def test_is_under_public_folder(self):
        ...
        file_info = FileInfo(
            ...
            access=AccessInfo(
                False, None, None, None, "restricted", None, None, None, False
            ),
        )
        ...
        file_info.location = (
            "/ClientA/Public/file.txt"  # Case sensitive check in code? currently yes
        )
        policy = check_policy(file_info, self.config)
        self.assertFalse(policy.is_under_public_folder)
    ...
    def test_is_public_anyone(self):
        ...
        file_info = FileInfo(
            ...
            access=AccessInfo(
                False, None, None, None, "anyone", "reader", None, None, True
            ),
        )
        policy = check_policy(file_info, self.config)
