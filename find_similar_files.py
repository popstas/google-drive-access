...
def find_similar_files(old_csv: Path, new_csv: Path, output_csv: Path, threshold: float = 0.95):
    ...
    fieldnames = [
        'similarity', 'old_location', 'old_file_id', 'old_name', 'old_mime_type',
        'new_location', 'new_file_id', 'new_name', 'new_mime_type',
    ]
