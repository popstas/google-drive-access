...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "granted_existing": "Granted: {granted}; Existing: {existing}, folder_url: {folder_url}",
        ...
        "share_file_already_shared": "File already has access with role {role}",
        ...
        "share_file_is_folder": "This link points to a folder, please paste a link to the document itself",
    ...
    "ru": {
        ...
        "granted_existing": "Выданы права: {granted}. Уже были права: {existing}. {folder_url}",
        ...
        "share_file_already_shared": "Файл уже расшарен с ролью {role}",
        ...
        "share_file_is_folder": "Это ссылка на папку, вставьте ссылку на сам документ",
